...
# get numbers with stopifnot
get_numbers2 <- function(a,b){
...
# get numbers with stopifnot
get_numbers3 <- function(a,b){
  
  tryCatch(
    expr = {
      message(stopifnot(is.numeric(a) & is.numeric(b)) )
      message("Data is correct type")
    },
    error = function(e){
      message('Wrong formats!')
    },
    warning = function(w){
      message('Wrong formats!')
    }
